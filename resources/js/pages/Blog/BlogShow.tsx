...
export default function BlogShow({ article, similar, urls }) {
  ...
  return (
    <>
      ...
      <div className="bg-black text-white pt-24 lg:pt-32 min-h-screen">
        <div className="flex flex-col lg:flex-row max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <main className="flex-1">
            <div className="max-w-4xl mx-auto py-12 lg:py-16">
              ...
              {/* Sommaire mobile */}
              {toc.length > 0 && (
                <details className="lg:hidden mb-10 bg-slate-900/50 rounded-xl border border-green-900/30 group">
